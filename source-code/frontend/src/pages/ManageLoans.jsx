  ...
  return ( // Giao diện
    <div className="container"> {/* Khung trang */}
      ...
      <table className="table"> {/* Bảng phiếu mượn */}
        <thead> {/* Tiêu đề bảng */}
          <tr><th>Sách</th><th>Người mượn</th><th>Trạng thái</th><th>Hạn trả</th><th>Phí phạt</th><th>Thao tác</th></tr> {/* Các cột */}
        ...
        <tbody> {/* Thân bảng */}
          ...
          {loans.length === 0 && <tr><td colSpan="6" className="muted">Không có phiếu nào.</td></tr>} {/* Thông báo khi rỗng */}
